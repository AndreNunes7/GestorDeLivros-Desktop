...
import com.mycompany.firebaseproject.Erro;
import com.mycompany.firebaseproject.Livro;
import com.mycompany.firebaseproject.LivrosBLL;
...
public class LivroIHM extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        LivrosBLL.validaDados('i',umlivro);
        if (Erro.getErro())
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        LivrosBLL.validaTitulo('c',umlivro);
        if (Erro.getErro())
            javax.swing.JOptionPane.showMessageDialog(null,Erro.getMens());
        else
            {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        umlivro.setLocalizacao(null);
        umlivro.setAnoEdicao(null);
        LivrosBLL.validaTitulo('d',umlivro);
        if (Erro.getErro())
            javax.swing.JOptionPane.showMessageDialog(null,Erro.getMens());
        else
            {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        umlivro.setAnoEdicao(tf4.getText());
        umlivro.setLocalizacao(tf5.getText());
        LivrosBLL.validaDados('a',umlivro);
        if (Erro.getErro())
            javax.swing.JOptionPane.showMessageDialog(null,Erro.getMens());
        else
